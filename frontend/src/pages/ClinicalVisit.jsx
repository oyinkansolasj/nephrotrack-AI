      ...
      <div className="p-4 sm:p-8 flex items-center justify-center">
        <div className="card p-6 sm:p-12 text-center max-w-md">
          ...
          <p className="text-slate-500 text-sm mb-6">
            Clinical visit for <strong>{patient?.first_name} {patient?.last_name}</strong> has been saved successfully.
          </p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="date" value={visitDate} onChange={e => setVisitDate(e.target.value)} className="input-field" />
                </div>
                <div>
                  <label className="label">Attending Clinician</label>
                  <input type="text" value={currentUser?.name ?? ''} className="input-field" readOnly />
                </div>
              </div>
              {patient && (
                <div className="bg-brand-50 border border-brand-200 rounded-lg p-3 text-sm text-brand-800">
                  Recording visit for <strong>{patient.first_name} {patient.last_name}</strong>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <p className="text-slate-500 mt-1">Visit type: {visitType} · {visitDate}</p>
                </div>
                <div className="bg-slate-50 rounded-lg p-4">
